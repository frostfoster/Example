                        ...
                        <form class="form-row" method="POST" action="{{ url('application_add') }}">
                            ...
                            <div class="form-group row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <select class="form-control form-control-sm" name="permit_id">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="otp">
                                    <label class="form-check-label" for="option1">
                                      OTP
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="moep">
                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell">
                                                <a class="btn" href="{{ url('edit-application/'.$item->id) }}"><span class="badge bg-success">Edit</span></a>
                                                <a class="btn" href="{{ url('delete-application/'.$item->id) }}"><span class="badge bg-danger">Delete</span></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
