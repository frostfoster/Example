                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell">
                                                <a class="btn" href="{{ url('edit-violation/'.$item->id) }}"><span class="badge bg-success">Edit</span></a>
                                                <a class="btn" href="{{ url('delete-violation/'.$item->id) }}"><span class="badge bg-danger">Delete</span></a>
                                            </td>
